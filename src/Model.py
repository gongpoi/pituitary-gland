...
class Model:
    ...
    def segmentation_model(self, compile=True):
        ...
        nr_units = 512
        for skip in skips:
            x = tf.keras.layers.Conv2DTranspose(int(nr_units), 3, strides=2, padding='same')(x)
        ...
        if compile:
            model.compile(optimizer='adam',
                ...
                metrics = [self.dice_coef_total, self.dice_coef_gland])
    ...
    def dice_coef_gland(self, y_true, y_pred):
