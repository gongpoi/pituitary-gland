...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(filepath=os.path.join(model_folder, 'slice-selection.weights.h5'), save_best_only=True, save_weights_only=True)
